...
func (v *VoiceConnection) IsWebSocketNil() (b bool) {
	if v.wsConn == nil {
		return true
	}
	return false
...
func (v *VoiceConnection) Ismute() (b bool) {
	return v.mute
}

func (v *VoiceConnection) Isdeaf() (b bool) {
	return v.deaf
}

func (v *VoiceConnection) Isspeaking() (b bool) {
	return v.speaking
}
...
func (v *VoiceConnection) onEvent(ctx context.Context, binary bool, message []byte) {
	...
	if binary {
		...
		case 4: // udp encryption secret key
			...
			go v.opusSender(ctx, 48000, 960*3)
